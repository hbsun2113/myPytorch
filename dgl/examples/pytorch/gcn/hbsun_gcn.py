...
class GCNLayer(nn.Module):
    def __init__(self,
        ...
        self.fc = nn.Linear(2 * out_feats, out_feats, bias=bias)
        self.activation = activation
    ...
    def forward(self, h):
        self.g1.ndata['h'] = self.linear1(self.dropout(h))
        self.g2.ndata['h'] = self.linear2(self.dropout(h))
...
class GCN(nn.Module):
    def __init__(self,
        ...
        # self.layers.append(MLP(n_hidden, n_classes, dropout, None))
